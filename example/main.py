...
def main():
    ...
    datastoreId = "8a23b5b729c44f0d8b15cfd06253c5cd" #Replace this value with your datastoreId.
    imageSetId = "c5fdaa101da9f693f795f433d503049d" #Replace this value with your imageSetId.
    ...
    #print(ImageSet_metdata)
    f = open("metads.json", "w")
    f.write(json.dumps(ImageSet_metdata))
    f.close()
    ...
    instances = helper.DICOMizeImageSet(datastore_id=datastoreId , imageset_id=imageSetId , header_only=True)
    end_time = time.time()
    dat = {}
    ...
    instances = helper.DICOMizeImageSet(datastore_id=datastoreId , imageset_id=imageSetId)
    for ins in instances:
